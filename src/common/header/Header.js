            ...
            <TabContainer>
              <FormControl required className="login-and-signup-forms">
                ...
                <FormHelperText className={this.state.loginContactNoRequired}>
                  <span className="red">
                    {this.state.loginContactNoRequiredMessage}
                  </span>
                </FormHelperText>
              </FormControl>
              <br />
              ...
              <FormControl required className="login-and-signup-forms">
                ...
                <FormHelperText className={this.state.loginPasswordRequired}>
                  <span className="red">
                    {this.state.loginPasswordRequiredMessage}
                  </span>
                </FormHelperText>
              </FormControl>
              <br />
              ...
              >
                <span id="login-error-msg" className="red">
                  {this.state.loginErroMessage}
                </span>
              </div>
              <br />
              <Button
            ...
            <TabContainer>
              ...
              <FormControl required className="login-and-signup-forms">
                ...
                <FormHelperText className={this.state.signupEmailRequired}>
                  <span className="red">
                    {this.state.signupEmailRequiredMessage}
                  </span>
                </FormHelperText>
              </FormControl>
              <br />
              ...
              <FormControl required className="login-and-signup-forms">
                ...
                <FormHelperText className={this.state.signupPasswordRequired}>
                  <span className="red">
                    {this.state.signupPasswordRequiredMessage}
                  </span>
                </FormHelperText>
              </FormControl>
              <br />
              ...
              <FormControl required className="login-and-signup-forms">
                ...
                <FormHelperText className={this.state.signupContactNoRequired}>
                  <span className="red">
                    {this.state.signupContactNoRequiredMessage}
                  </span>
                </FormHelperText>
              </FormControl>
              <br />
              ...
              >
                <span id="signup-error-msg" className="red">
